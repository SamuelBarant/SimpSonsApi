...
class CharacterDetailPhrasesAdapter (private val listPhrases: List<String>) :
    ...
    class ViewHolder(private val binding: ItemCharacterPhrasesBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCharacterPhrasesBinding.inflate(LayoutInflater.from(parent.context),parent,false)
